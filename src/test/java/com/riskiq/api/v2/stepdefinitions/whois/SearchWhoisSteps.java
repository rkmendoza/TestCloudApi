...
public class SearchWhoisSteps extends FlowData  {


  @When("^users with wrong credentials want Get Search Whois with the values$")
  public void users_with_wrong_credentials_want_Get_Search_Whois_with_the_values(DataTable dataTable) {
  ...
  public void users_in_the_same_organization_want_Get_Search_Whois_with_the_values(DataTable dataTable) {
    rs.set(setCredentials(userName2, userPw2));
    GetSearchWhois(dataTable);
  }

  @When("^user not in the same organization want Get Search Whois with the values$")
  public void user_not_in_the_same_organization_want_Get_Search_Whois_with_the_values(DataTable dataTable) {
  ...
  public void users_in_the_same_organization_which_created_the_project_want_Get_Search_Whois_with_the_values(DataTable dataTable) {
    rs.set(setCredentials(userName2, userPw2));
    GetSearchWhois(dataTable);
  }
