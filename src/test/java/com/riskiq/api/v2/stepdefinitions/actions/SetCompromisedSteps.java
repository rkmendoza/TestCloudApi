...
public class SetCompromisedSteps extends FlowData  {

  @When("^users with wrong credentials want Set Compromised Status with the values$")
  public void users_with_wrong_credentials_want_Set_Compromised_Status_with_the_values(DataTable dataTable) {
  ...
  public void users_in_the_same_organization_want_Set_Compromised_Status_with_the_values(DataTable dataTable) {
  ...
  public void user_not_in_the_same_organization_want_Set_Compromised_Status_with_the_values(DataTable dataTable) {
  ...
  public void users_in_the_same_organization_which_created_the_project_want_Set_Compromised_Status_with_the_values(DataTable dataTable) {
    rs.set(setCredentials(userName2, userPw2));
    SetCompromised(dataTable);
  }
